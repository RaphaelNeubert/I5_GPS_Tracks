...
. Speichern der GPS-Tracks +
    Die GPS-Tracks werden auf dem Endgerät des Nutzers gespeichert und, sofern man Internet verbindung hat, auf dem Server in einer dafür geeigneten Datenbank. Die GPS-Tracks werden in Einer Datenbank gespeichert, damit man auch von einem anderen Gerät diese Abrufen kann.
