...
* *UC03*: GPS-Tracks bearbeiten
* *UC04*: Wiederaufnahme von GPS-Tracks
* *UC05*: GPS-Tracks über Server verwalten
* *UC06*: Besondere(n) Punkt(e) in Track einfügen
* *UC07*: Verbesserung existierender Tracks durch erneute Aufnahme
