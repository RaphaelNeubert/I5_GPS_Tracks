...
*NFAU-4: Der Nutzer sollte maximal 4 Klicks brauchen um entweder einen Track aufzunehmen oder sich die Details zu einem beliebigen Track anzeigen zu lassen.* +
...
Zur Überprüfung wird getestet, ob in einem Langzeittest der Server sowie der Kartendatenprovider
zu 95% der Zeit erreichbar ist.
