...
*FNAF-2: Man muss den Löschvorgang eines GPS-Tracks zweimal bestätigen* + 
...
bekommt, ein entsprechender Hinweistext angezeigt wird.
*NFAR-2: Der Server muss zu 95% verfügbar sein*
...
Zur Überprüfung wird ein automatischer Test feststellen, ob alle Anforderungen innerhalb der gegebenen Zeit unter optimalen Bedingungen ablaufen.
...
* Die GPS-Tracks sollen in einem standartisierten Dateiformat z.B. GEOJson oder GPX gespeichert werden.
