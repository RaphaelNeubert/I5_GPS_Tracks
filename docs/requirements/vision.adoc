...
An der HTW Dresden wird im Modul Software Engineering 1 eine Projektarbeit gefordert, bei welcher ein zusammengestelltes Team aus Studenten einen Auftrag erfüllen müssen. Ein Professor ist auf diese Projektarbeit zugekommen und möchte für seine mobilen Roboter eine Smartphone App erstellt haben, welche durch GPS-Tracks den Roboter auf der Weltkarte orten kann, um dem Roboter per App an bestimmten Orten Aufgaben zuteilen zu können. Da die meißten GPS-Track Apps nur sehr ungenaues GPS-Signal liefern und es dabei nicht möglich ist, bestimmte Punkte für die Aufgabenverteilung an den Roboter auszuwählen, erhofft sich der Professor dass der mobile Roboter durch die App auch aus großer Entfernung zum Nutzer benutzt werden kann.
...
[cols="1,3"]
|===
| Das Problem | Die mobilen Fahrroboter können nicht präzise geortet werden und keine Aufgaben erfüllen
| betrifft | Studenten und Professoren, welche Aufgaben an den Roboter delegieren wollen
| die Auswirkung davon ist | Roboter kann nicht aus großer Entfernung benutzt werden
| eine erfolgreiche Lösung wäre | Eine App, welche denn kompletten Weg des Roboters auf der Karte aufnehmen kann und spezielle Punkte (auf der Karte) bestimmt, bei welchen Aufgaben vom Roboter erledigt werden.
|===
...
[cols="1,3"]
|===
| Für | Studenten, Professoren
| die | mit dem Roboter arbeiten
| Das Produkt / die Lösung ist eine | mobile App für Smartphones
| die | das erstellen von GPS-Tracks und durch eintragen bestimmter Punkte auf der Karte, die Aufgabenverteilung an den Roboter ermöglicht
| Im Gegensatz zu | sehr ungenauen GPS-Track Apps ohne Möglichkeit zur Aufgabenverteilung
| Unser Produkt | unterstützt die präszise Erstellung von GPS-Tracks und die Aufgabenvertreilung an den Roboter
|===
...
==== Student / Professor 
* muss GPS-Track aufnehmen können
* GPS-Track auf der Karte anzeigen lassen können 
* GPS-Track bearbeiten können
* zuvor aufgenommene GPS-Tracks wieder anzeigen lassen können
* GPS-Tracks über den Server verwalten können
* Besondere Punkte in den Track einfügen, um dem Roboter an bestimmten Punkten der Karte Aufgaben verteilen zu können
* durch erneutes Aufnehmen existierender GPS-Tracks die Genauigkeit erhöhen
* Darstellung auf einer mobilen App
* Verwendung mit Touchbedienung
...
| GPS-Track aufnehmen | hoch | zurückgelegter Weg des Roboters speichern |
| GPS-Track auf Karte anzeigen | hoch | zurückgelegter Weg des Roboters auf Karte anzeigen |
|GPS-Track bearbeiten | hoch | |
|Wiederaufnahme von GPS-Track| mittel | |
|===
...
| System muss auf allen mobilen Android Geräten lauffähig sein | hoch | 
|===
