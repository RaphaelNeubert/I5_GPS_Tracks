...
| die | das erstellen von GPS-Tracks und durch eintragen bestimmter Punkte des GPS-Tracks auf der Karte, die Aufgabenverteilung an den Roboter ermöglicht
...
| Aufagbenveretilung an mobilen Roboter | mittel | einfügen besonderer Punkte in GPS-Track  |
|===
