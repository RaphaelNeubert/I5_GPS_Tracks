...
Dieses Visions-Dokument bezieht sich auf das {project-name}, das von I5 entwickelt wird. Das System wird es Benutzer erlauben, mobile App für Smartphones zu nutzen, um damit die Genauigkeit von GPS-Daten zu erreichen und die Aufgaben an den Roboter zu delegieren.
...
welche das erstellen von Strecken für mobilen Roboter ermöglicht. 
