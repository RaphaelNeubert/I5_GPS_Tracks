...
[cols="1,3"]
|===
| Das Problem | Die mobilen Fahrroboter können nicht geortet werden und keine Aufgaben erfüllen
| betrifft | Nutzer welche Aufgaben an den Roboter delegieren wollen (Studenten, Professoren)
| die Auswirkung davon ist | Roboter kann keine Aufgaben erfüllen
...
[cols="1,3"]
|===
| Für | Nutzer der App (Studenten, Professoren, Privatpersonen)?
