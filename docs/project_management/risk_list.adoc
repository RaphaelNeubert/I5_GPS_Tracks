...
Die Risiken sind in der folgenden Tabelle dargestellt. Das Datum des Dokuments oben gibt an, wann die Risikoliste zuletzt aktualisiert wurde.
...
//include::risks.csv[]
//|===
image::risks_geschaeftlich.png[title="Risikotabelle, geschäftlich", align="center"]
image::risks_ressourcen.png[title="Risikotabelle, Ressourcen", align="center"]
image::risks_technisch.png[title="Risikotabelle, technisch", align="center"]
image::risks_zeitlich.png[title="Risikotabelle, zeitlich", align="center"]
