...
\subsection{Produktergebnis [AP]}
    ...
    Mit unserer App kann man GPS-Routen erstellen, anpassen, löschen oder mit anderen Geräten über den Server austauschen. Die App unterstützt auch die Funktion, eine bestimmte Aktion für Roboter
    ...
    und im Dateisystem des Servers gespeichert, deswegen unser Server-App mit Docker leicht auf anderen Diensten eingesetzt werden kann. Man können zum Beispiel einen Raspberry Pi verwenden und darauf
