...
\subsubsection{Aleksandr Pronin}
    ...
    Das Domänenmodell, das uns zeigt, welche Elemente im initialen MVP vorkommen sind, wurde schon aufgestellt.
    Ich hatte also eine gute Vorstellung davon, wie meine Arbeit ablaufen sollte.  Im Rahmen agile Vorgehensweisen 
    sprachen wir ständig mit unserem Stakeholder Prof. Neugebauer, um die Anforderungen an die App zu konkretisieren. 
