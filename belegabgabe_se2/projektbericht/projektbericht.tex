...
(Iteration 2, 3)
Nach dem Abschluss der Inception-Phase begann die Elaboration Phase. Das wir die Inception-Phase nicht optimal 
...
Zunächst beschrieben wir alle Textuell, merkten aber, dass es für einen der Use-Cases Sinn machte ein UML-Aktivitätsdiagramm 
zu verwenden.\par 
\medskip
...
hat uns daher sehr überzeugt und wir nehmen uns vor, diese auch in zukünftigen Projekten zu verwenden.


% Vision nachholen 
% use cases ausarbeiten 
% besprechung wireframes mit ts 
% FURPS
% technologien
% domänenmodell
% prototyp
