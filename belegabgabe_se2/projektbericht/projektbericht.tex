...
\subsection {Ausgangssituation [AS]}
Am Ende des Moduls SE1 hatten wir einen guten umfassenden Überblick in das System und den funktionalen Anforderungen gewonnen. 
Ebenso waren erste Funktionalitäten bereits implementiert. \\ Zwei Mitglieder aus dem Studiengang Wirtschaftsingenieurwesen, verabschiedeten 
sich am Ende des SE1 Projektes. Außerdem verließ ein weiteres Mitglied die Gruppe. Somit verkleinerte sich unsere Gruppe von acht Mitgliedern,
auf fünf. Jedoch bekamen aufgrund unserer geringen Kapazität, gegenüber anderen Gruppen ein Ersatzmitglied (Aleksandr Pronin). \\
Im ersten Meeting brachten wir alle Mitglieder nochmal auf den selben Informationsstand, über die Aufgabenstellung und den Fortschritt. 
Außerdem überprüften wir unsere grobe Rollenverteilung und verteilten die Aufgabenbereiche (Server u. App implementierung, Analyst, Tester etc.)
auf die Mitglieder auf. Somit hatten wir alle Voraussetzungen für einen guten Start in das laufende Projekt in SE2.
\subsection {Rollenverteilung [AP]}
    Die Rollen im Team waren nicht streng verteilt. Jeder war in seinem Bereich und entsprechend seinen Kompetenzen an dem Projekt beteiligt.
    Die Aufgabenverteilung war im Grunde sehr ähnlich wie beim Planning Poker. Jeder bewertete die Schwierigkeit der Aufgabe nach seinen eigenen Stärken und
    dann wurden die Aufgaben unter Absprache der gesamten Gruppe verteilt. Der Status wurde über Github-Issues verwaltet. \\
    Das gesammte Team besteht aus sechs Mitgliedern: Raphael Neubert, Aleksandr Pronin, Ludwig Schöntthier, Alex Schechtel, Tom Nicolai und Quang Duy Pham.
    Eine ungefähre Verteilung der Rollen ist in der Tabelle dargestellt.
    \begin{table}[H]
        \begin{tabular}{lllll}
        \textbf{Name} & \textbf{Rolle} &  &  \\
        Raphael Neubert                & Developer, Architekt, Projektmanager        &  &  \\
        Aleksandr Pronin               & Developer, Lösungarchitekt                  &  &  \\
        Ludwig Schöntthier             & Analyst                                     &  &  \\
        Alex Schechtel                 & Developer, Any Role                        &  &  \\
        Tom Nicolai                    & Developer, Tester                           &  &  \\
        Quang Duy Pham                 & Tester                                      &  &  \\
        \end{tabular}
    \end{table}
\newpage
...
\subsection{Bewertung [AP]}
    ...
    an den Server gesendet werden kann und dann alle Geräte in unserem Netzwerk infiziert sein können. Aus diesem Grund sollte nächste logische Entwicklungsschritt
