...
\subsubsection{Phase: Inception [AS]}
(Iteration 1) \\
In der Phase \dq Inception" war es das Ziel für das Team, ein gutes Grundverständnis für die Aufgabenstellung zu erhalten 
und die Ziele des Projektes klar zu machen. Dabei sollten alle Akteure für die App sowie auch Schnittstellen definiert werden. 
Somit erstellten wir die Vision um ein Dokument zur Orientierung des Projektes für das Team bereitzustellen.
Ebenso erstellten wir die ersten Use Cases zum Projekt und besprachen mit dem Auftraggeber die Prioritäten der Funktionalitäten.
Um eine Grundarchitektur des Projektes aufzubauen überlegten wir uns im Team, welche Entwicklungsumgebungen mit deren Bibliotheken und Programmiersprachen 
(wie die Funktionalitäten am besten umgesetzt werden können) wir nutzen sollten und klärten dies ebenso mit dem Auftraggeber ab.
Dadurch haben wir als Team recht schnell, ein klares Ziel vor Augen gehabt und eine gute Grundarchitektur.
Außerdem sollte eine Projektumgebung für die Teamarbeit eingerichtet werden. Wir benutzten GitHub als Projektplaner und
Element zur Kommuniaktion untereinander. Zur Dokumentation benutzten wir in SE1 AsciiDoc und im verlaufe von SE2 wechselten wir zu LaTeX.
\subsubsection{Phase: Elaboration [LS]}
(Iteration 2, 3)
Diese Phase diente vor allem der Vorbereitung der Implementierung des Grundgerüstes unserer Applikation. Das Team arbeitete hierbei an der Ausarbeitung
von systemweiten Anforderungen und wie diese umzusetzen waren. Weiterhin entwarf man Wireframes und besprach diese mit dem Themensteller um sicherzugehen, dass das Aussehen
