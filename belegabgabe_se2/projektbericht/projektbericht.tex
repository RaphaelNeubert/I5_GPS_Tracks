...
\subsection{Produktergebnis [AP]}
    ...
    Insgesamt wurden im Rahmen des Projekts 445 Commits von Git verwendet, 1.295 Zeilen Source-Code und 157 Zeilen Kommentare geschrieben. 
    Für die App wurden insgesamt 7 Java Klassen entworfen. Diese können im Klassendiagramm genauer betrachtet werden. (stand 02.02.2022)
    \begin{center}
        \includegraphics[scale=0.4]{uml_classendiag.png}
    \end{center}
